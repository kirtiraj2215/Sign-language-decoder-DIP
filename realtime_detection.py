    ...
    if hand_landmarks:
        for hand_landmark in hand_landmarks:
            ...
            for coordinates in hand_landmark.landmark:
                normalized_landmarks.extend([coordinates.x - min_x, coordinates.y - min_y])
...
# Example to run the update_frame function (assuming a Tkinter GUI):
...
# Create a text area to show the predicted sentence
...
root.protocol("WM_DELETE_WINDOW", release_video)  # Clean up when the window is closed
root.mainloop() 